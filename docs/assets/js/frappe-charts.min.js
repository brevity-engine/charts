var frappe = (function () {
  ...
  function p(t, e) {
    return { x: Math.sin(t * Zt) * e, y: Math.cos(t * Zt) * e };
  }
  function f(t) {
    var e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
    return (
      !Number.isNaN(t) && void 0 !== t && !!Number.isFinite(t) && !(e && t < 0)
    );
  }
  function v(t) {
  ...
  function g(t) {
    ...
    if ("object" !== (void 0 === t ? "undefined" : Ht(t)) || null === t)
      return t;
    e = Array.isArray(t) ? [] : {};
  ...
  function L(t, e) {
    ...
    for (var n in e) {
      var a = e[n];
      if ("inside" === n) T(a).appendChild(i);
      else if ("around" === n) {
        var s = T(a);
        s.parentNode.insertBefore(i, s), i.appendChild(s);
      } else
        "styles" === n
          ? "object" === (void 0 === a ? "undefined" : Ht(a)) &&
  ...
  function C(t, e, i, n) {
    return L("svg", { className: e, inside: t, width: i, height: n });
  }
  function D(t) {
  ...
  function H(t, e, i, n) {
    var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : Jt,
      s =
  ...
  function I(t, e, i) {
    ...
    var s = {
      ...
      o = L("g", { transform: "translate(" + t + ", " + e + ")" });
    return o.appendChild(L("rect", s)), o.appendChild(r), o;
  }
  function R(t, e, i) {
    var n =
        arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : "none",
    ...
    var s = { className: "legend-dot", cx: 0, cy: 0, r: i, fill: n },
      ...
      o = L("g", { transform: "translate(" + t + ", " + e + ")" });
    return o.appendChild(L("circle", s)), o.appendChild(r), o;
  }
  function Y(t, e, i, n) {
  ...
  function V(t, e, i, n) {
    ...
    var s = L("line", {
      ...
      o = L("g", { transform: "translate(0, " + t + ")", "stroke-opacity": 1 });
    return (
  ...
  function U(t, e, i) {
    ...
    f(t) || (t = 0),
      ...
      n.offset || (n.offset = 0),
      n.mode || (n.mode = "span"),
      n.stroke || (n.stroke = oe),
      n.className || (n.className = "");
    var a = -1 * ne,
      s = "span" === n.mode ? i + ne : 0;
    return (
      "tick" === n.mode && "right" === n.pos && ((a = i + ne), (s = i)),
      (a += n.offset),
      (s += n.offset),
      V(t, e, a, s, {
        stroke: n.stroke,
  ...
  function G(t, e, i) {
    ...
    f(t) || (t = 0),
      ...
      n.className || (n.className = "");
    var a = i + ne,
      s = "span" === n.mode ? -1 * ne : i;
    return (
      "tick" === n.mode && "top" === n.pos && ((a = -1 * ne), (s = 0)),
      B(t, e, a, s, {
        stroke: n.stroke,
        className: n.className,
        lineType: n.lineType,
  ...
  function q(t, e, i) {
    ...
    var a = L("text", {
        ...
        x: "left" === n.labelPos ? ae : i - d(e, 5) - ae,
        y: 0,
        dy: re / -2 + "px",
        "font-size": re + "px",
        "text-anchor": "start",
  ...
  function X(t, e, i, n) {
    ...
    var o = L("text", {
        className: "chart-label",
        x: "left" === a.labelPos ? ae : i - d(n + "", 4.5) - ae,
        y: 0,
        dy: re / -2 + "px",
        "font-size": re + "px",
        "text-anchor": "start",
  ...
  function J(t, e, i, n) {
    var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : "",
      ...
      c = u[1];
    (c -= r),
      0 === h && ((h = o.minHeight), (c -= o.minHeight)),
      f(t) || (t = 0),
      f(c) || (c = 0),
      f(h, !0) || (h = 0),
      f(i, !0) || (i = 0);
    ...
    if (n.regionFill) {
      var u = F(a.svgDefs, i, !0),
        h =
          ...
          "," +
          a.zeroLine;
      l.region = S(h, "region-fill", "none", "url(#" + u + ")");
    }
    return l;
  }
  function Q(t, e, i, n) {
  ...
  function Z(t, e, i) {
    return Q(t, [i, 0], [e, 0], pe);
  }
  function tt(t, e, i) {
    return Q(t, [0, i], [0, e], pe);
  }
  function et(t, e, i, n) {
    var a = e - i,
      s = t.childNodes[0];
  ...
  function it(t, e, i, n) {
    ...
    return (
      ...
      "rect" !== t.nodeName
        ? [
            [t.childNodes[0], { width: n, height: o }, ce, ve],
            Q(
              t,
        ...
        : [[t, { width: n, height: o, x: e, y: l }, ce, ve]]
    );
  }
  function nt(t, e, i) {
  ...
  function at(t, e, i, n, a) {
    var s = [],
      r = i
        ...
        .join("L");
    a && (r = k(e, i));
    var o = [t.path, { d: "M" + r }, de, ve];
    if ((s.push(o), t.region)) {
      var l = e[0] + "," + n + "L",
        u = "L" + e.slice(-1)[0] + ", " + n,
        h = [t.region, { d: "M" + l + r + u }, de, ve];
      s.push(h);
    }
    return s;
  }
  ...
  function lt(t, e) {
    ...
    e.map(function (t) {
      var e = t[0],
        ...
        r = void 0;
      t[0] = e;
      var o = rt.apply(void 0, Ut(t)),
        l = Vt(o, 2);
      (s = l[0]),
        (r = l[1]),
        i.push(r),
        n.push([s, a]),
        a && a.replaceChild(s, e);
    });
    var a = t.cloneNode(!0);
    return (
      n.map(function (t, n) {
  ...
  function ct(e) {
    ...
    var n = t.create("style", { innerHTML: me });
  ...
  function Lt(t) {
    function e(t, e) {
      for (var i = Tt(t), n = i[1] - i[0], a = 0, s = 1; a < e; s++)
        (a += n), i.unshift(-1 * a);
      return i;
    }
    var i = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
      n = Math.max.apply(Math, Ut(t)),
      a = Math.min.apply(Math, Ut(t)),
      s = [];
    if (n >= 0 && a >= 0) At(n)[1], (s = i ? Tt(n, a) : Tt(n));
    else if (n > 0 && a < 0) {
      var r = Math.abs(a);
      n >= r
        ? (At(n)[1], (s = e(n, r)))
      ...
      var o = Math.abs(a),
        l = Math.abs(n);
      At(o)[1],
        (s = (s = i ? Tt(o, l) : Tt(o)).reverse().map(function (t) {
          return -1 * t;
        }));
    }
    return s;
  ...
  function St(t, e) {
    for (
      var i = Math.max.apply(Math, Ut(t)), n = 1 / (e - 1), a = [], s = 0;
      s < e;
      s++
    ) {
      var r = i * (n * s);
  ...
  function _t(t, e) {
    ...
    return (
      ...
      n.map(function (t) {
        ...
        t.chartType || (Xt.includes(e), (t.chartType = e));
      }),
      t.yRegions &&
  ...
  t.create = function (e, i) {
    ...
    for (var a in i) {
      ...
      if ("inside" === a) t(s).appendChild(n);
        ...
        "styles" === a
          ? "object" === (void 0 === s ? "undefined" : Ht(s)) &&
  ...
  var Gt = {
          ...
          },
          {
            ...
            value: function () {
              ...
              (this.container = t.create("div", {
                ...
                (this.dataPointList =
                  this.container.querySelector(".data-point-list")),
    ...
    ye = (function () {
      function e(t, i) {
        ...
        (this.rawChartArgs = i),
          ...
          (this.measures = JSON.parse(JSON.stringify(Gt)));
        var n = this.measures;
        this.setMeasures(i),
      ...
      return (
        It(e, [
          ...
          { key: "calc", value: function () {} },
          {
            key: "updateWidth",
            value: function () {
              (this.baseWidth = a(this.parent)),
                (this.width = this.baseWidth - u(this.measures));
            },
          },
          {
            key: "makeChartArea",
    ...
    be = (function (t) {
      function e(t, i) {
        return (
          jt(this, e),
          Bt(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, i))
        );
      }
      return (
        Yt(e, t),
    ...
    Le = {
      ...
      yAxis: {
        ...
        makeElements: function (t) {
          ...
          return t.positions.map(function (i, n) {
            return U(i, t.labels[n], e.constants.width, {
      ...
      xAxis: {
        ...
        makeElements: function (t) {
          var e = this;
          return t.positions.map(function (i, n) {
            return G(i, t.calcLabels[n], e.constants.height, {
              mode: e.constants.mode,
              pos: e.constants.pos,
            });
          });
      ...
      yMarkers: {
        ...
        makeElements: function (t) {
          ...
          return t.map(function (t) {
            return q(t.position, t.label, e.constants.width, {
      ...
      yRegions: {
        ...
        makeElements: function (t) {
          var e = this;
          return t.map(function (t) {
            return X(t.startPos, t.endPos, e.constants.width, t.label, {
              labelPos: t.options.labelPos,
            });
          });
        },
        ...
        makeElements: function (t) {
          ...
          return (
            ...
            t.cols.map(function (t, i) {
              1 === i &&
                e.labels.push(
                  Y("domain-name", l, -12, yt(n, !0).toUpperCase(), {
                    fontSize: 9,
                  })
                ),
                t.map(function (t, i) {
        ...
        animateElements: function (t) {
          ...
          return (
            this.store.map(function (a, s) {
              m = m.concat(
                it(a, e[s], i[s], t.barWidth, n[s], { zeroLine: t.zeroLine })
              );
            }),
            m
          );
        ...
        animateElements: function (t) {
          ...
          return (
            Object.keys(this.paths).length &&
              (p = p.concat(
                at(this.paths, e, i, t.zeroLine, this.constants.spline)
              )),
            this.units.length &&
              this.units.map(function (t, n) {
                p = p.concat(nt(t, e[n], i[n]));
              }),
            p
          );
        },
            ...
            value: function () {
              ...
              e.sliceTotals.map(function (i, o) {
                var l = r,
                  ...
                  y = void 0;
                t.init
                  ? ((m = g ? g.startPosition : f), (y = g ? g.endPosition : f))
                  : ((m = f), (y = v));
                var b =
                  360 === u
                    ? _(m, y, t.center, t.radius, a, h)
                    : E(m, y, t.center, t.radius, a, h);
        ...
        It(e, [
          {
            ...
            value: function (t) {
              ...
              (this.discreteDomains = 0 === t.discreteDomains ? 0 : 1),
                ...
                (e.paddings.bottom = 0),
                (e.legendHeight = 24),
                (e.baseHeight = 12 * xe + l(e));
              var i = this.data,
                n = this.discreteDomains ? 12 : 0;
              this.independentWidth = 12 * (vt(i.start, i.end) + n) + u(e);
            },
          },
          {
            key: "updateWidth",
          ...
          },
          {
            ...
            value: function () {
              var t = this.state;
              (t.start = ft(this.data.start)),
                (t.end = ft(this.data.end)),
                (t.firstWeekStart = ft(t.start)),
                (t.noOfWeeks = vt(t.start, t.end)),
                (t.distribution = St(Object.values(this.data.dataPoints), 5)),
          ...
          },
          {
            ...
            value: function () {
              ...
              this.components = new Map(
                n.map(function (t, e) {
                  var i = wt.apply(void 0, Ut(t));
                  return [t[0] + "-" + e, i];
                })
              );
              var a = 0;
              Pe.forEach(function (e, i) {
                if ([1, 3, 5].includes(i)) {
                  var n = Y("subdomain-name", -6, a, e, {
                    fontSize: 10,
                    dy: 8,
                    textAnchor: "end",
                  });
            ...
            value: function () {
              ...
              (e = 30),
                ...
                this.colors.slice(0, 5).map(function (n, a) {
                  var s = j("heatmap-legend-unit", e + 15 * a, 12, 10, i, n);
                  t.legendArea.appendChild(s);
                });
              var a = Y("subdomain-name", e + 75 + 3, 12, "More", {
                fontSize: 11,
                dy: 9,
              });
          ...
          },
          {
            ...
            value: function () {
              for (
                ...
                r.push(this.getDomainConfig(o, u)), kt(u, 1), (o = u);
              }
              return r;
            },
          },
          {
            ...
            value: function (t) {
              var e =
                ...
                r = { index: n, cols: [] };
              kt((e = ft(e) || bt(n, a)), 1);
              for (var o = vt(s, e), l = [], u = void 0, h = 0; h < o; h++)
                (u = this.getCol(s, n)),
                  l.push(u),
                  kt((s = new Date(u[xe - 1].yyyyMmDd)), 1);
              return (
                void 0 !== u[xe - 1].dataValue &&
                  (kt(s, 1), l.push(this.getCol(s, n, !0))),
                (r.cols = l),
                r
              );
            },
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return {
                yyyyMmDd: e,
                dataValue: i || 0,
                fill: this.colors[Et(i, this.state.distribution)],
              };
            },
          },
        ]),
        ...
        It(i, [
              ...
              this.data.yMarkers &&
                ...
                this.data.yRegions &&
                  (this.state.yRegions = this.data.yRegions.map(function (e) {
                    return (
                      (e.startPos = Dt(e.start, t.yAxis)),
                      (e.endPos = Dt(e.end, t.yAxis)),
                      e.options || (e.options = {}),
                      e
                    );
                  }));
            ...
            value: function () {
              ...
              this.container.addEventListener("mousemove", function (i) {
                var n = t.measures,
                  ...
                  l = i.pageY - a.top;
                l < t.height + r(n) && l > r(n)
                  ? t.mapTooltipXPosition(s)
                  : t.tip.hideTip();
              });
            },
          },
          {
            ...
            value: function (t) {
              var e = this.state;
              if (e.yExtremes) {
                var i = Nt(t, e.xAxis.positions, !0);
                if (i >= 0) {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (t = parseInt(t)) < 0 && (t = 0),
                ...
                t !== e.currentIndex &&
                  ((e.currentIndex = t),
                  s(this.parent, "data-select", this.getDataPoint()));
            },
          },
          {
            key: "addDataPoint",
          ...
          },
          {
            ...
            value: function () {
              ...
              e.sliceTotals.map(function (i, o) {
                ...
                var b =
                  360 === u
                    ? W(m, y, t.center, t.radius, t.clockWise, h)
                    : z(m, y, t.center, t.radius, t.clockWise, h);
                e.sliceStrings.push(b),
                  e.slicesProperties.push({
                    startPosition: f,
                    endPosition: v,
    ...
    Se = { bar: De, line: De, percentage: Oe, heatmap: Ce, pie: Me, donut: Ne },
    Ee = function t(e, i) {
      return jt(this, t), Ft(i.type, e, i);
    },
    _e = Object.freeze({
      Chart: Ee,
      PercentageChart: Oe,
    ...
    ze = {};
  return (
    (ze.NAME = "Frappe Charts"),
    (ze.VERSION = "1.5.8"),
    (ze = Object.assign({}, ze, _e))
  );
})();
